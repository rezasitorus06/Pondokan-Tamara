...
<body class="admin-page">
    ...
    <main class="admin-content admin-room-picker">
        <div class="admin-title"><div><p class="eyebrow">Kelola kamar</p><h1>Pilih kamar.</h1><p class="admin-muted">Pilih kamar pada denah untuk mengubah detail, status, harga, atau fasilitasnya.</p></div></div>
